...
save(make.rec.mx, sig.genes, run.ave.m, emp.vec, geno.names, file='NRAM.algorithm.w.mean.se.RData')
...
save(g.distr.pt0.l2a, file='gamma.pdf.model.RData')
...
exp.dat = read.delim("final_selected_ETI_libraries_gene_counts.R_input_matrix.txt", header = T, row.names = 1)
dim(exp.dat)
#[1] 33603   540
...
save(exp.one.d, offset.cval.90, fix.ef, cval.90, ps.c, genotypes, file='exp.one.d.RData')

#### FigS1. visualize all data, genotype/time/rep for all genes

### load data
rm(list=ls())
load('exp.one.d.RData')
...
save(all.est, hclust.genes.all, file='hclust.genes.all.samp.pearson.complete.RData')
...
png(file = 'FigS1.all.540lib.x.18978genes.all.not.scaled2.png', width = 15*900, height = 6.5*600, res=300)
...
save(glm.coefs, genotypes, fix.ef, gene.names, cval.90, ps.c,
     file='Ed-AvrRpt2_DI_210223.RData')
...
save(ne.genes, four.genes, r.genes, file='genes.to.be.removed.RData')
...
save(genes.dyn,genes.var.geno, file='selected.genes.dynamics.and.geno.variation.RData')
#######
...
#### load data
rm(list=ls())
load('Ed-AvrRpt2_DI_210223.RData')
load('genes.to.be.removed.RData')
...
pdf('Fig1A.PCA.JEPS.xxxx.r2r1.GUS.r1.pdf', width=11, height = 6.6)
...
pdf('Supple.Fig1A.PCA23.JEPS.xxxx.r2r1.GUS.r1.pdf', width=11, height = 9)
...
pdf('Supple.Fig1A.PCA13.JEPS.xxxx.r2r1.GUS.r1.pdf', width=11, height = 5)
...
save(pca.slim, glm.c.slim, file='four.geno.all.pca.RData')
...
jpeg("Fig1B.r2r1.GUS.JEPS.comp.jpeg",height = 90, width = 35, units = "mm",res = 300)
...
rm(list=ls())
load('Ed-AvrRpt2_DI_210223.RData')
load('selected.genes.dynamics.and.geno.variation.RData')
...
save(G.corrected.tcv, file='EdGUS.corrected.mock.v210906.RData')

##################
#### load data
rm(list=ls())
load('EdGUS.corrected.mock.v210906.RData')
...
save(Ed.dyn.dat, file='Ed.dyn.dat.v230327.RData')
...
save(ear.p.genes, ear2.p.genes, ear3.p.genes, file='genes.for.gam.model.v230327.RData')
...
save(gm.fit, gm.fit2, gm.fit3, file='gm.fit.v230327.RData')

#################
#### order the genes according to pt, and split by ph sign
rm(list=ls())
load('gm.fit.v230327.RData')
load('genes.to.be.removed.RData')
...
save(gfa.names1.posi, gfa.names1.nega, file='ETI.gfa.sorted.genes.v230327.RData')
...
### load data
rm(list=ls())
load('Ed.dyn.dat.v230327.RData') # corrected mock subtracted
load('ETI.gfa.sorted.genes.v230327.RData') # modeled gene sets, up and down, pt ordered, this is recursive
...
jpeg("Fig3.corrected.Ed.vsm.v230327.jpeg",height = 160, width = 150, units = "mm",res = 300)
...
##########
##### Fig 2C (and its SuppFig, Fig S2). PC1 coordinates for combinatorial genotype time points
...
var.val.p = var.val/sum(var.val)
pdf('Fig3C.PCA.16geno.res.tc.v230327.pdf', width=10, height = 5.5)
...
pdf('Fig3D.PC1.16geno.v230327.pdf', height=5.5, width=6)
...
save(pca.dyn, pc1.geno.time, file='pca.dyn.comb.geno.RData')
...
rm(list=ls())
load('Ed-AvrRpt2_DI_210223.RData')
load('ETI.gfa.sorted.genes.v230327.RData') # 3261 modeled gene sets
load('pca.dyn.comb.geno.RData')
...
pdf('Fig2A.AvrRpt2.mRNAlevel.pdf', height = 7, width = 8)
...
pdf('Fig2B.correlation.wAvrRpt2.cc.v233037.pdf', height = 5, width = 5)
...
pdf('Fig2C.xve.mRNAlevel.pdf', height = 7, width = 7)
...
pdf('Fig2D.corr.xve.avrrpt2rate.v230327.pdf', height = 5, width = 5)
plot(0,0,
...
load('gm.fit.v230327.RData')
load('EdGUS.corrected.mock.v210906.RData')
load('ETI.gfa.sorted.genes.v230327.RData') # modeled gene sets, up and down, pt ordered
...
#### plots
tx1 = seq(0,6,0.05)
pdf('FigS3.data.gammamodel.v230327.pdf', height = 10, width = 7.5)
...
jpeg("FigS2.model.fit2.v230327.jpeg",height = 160, width = 270, units = "mm",res = 300)
...
write.csv(ts.tab, file='TableS1.para.vals.fitted.vals.csv')
...
##### function definitions
load('NRAM.algorithm.w.mean.se.RData')
...
save(pt.nram, ph.nram, file='gammamodel.para.NRAM.v230327.RData')
...
load('Ed.dyn.dat.v230327.RData') # corrected mock subtracted
load('gm.fit.v230327.RData')
load('gammamodel.para.NRAM.v230327.RData')
load('pca.dyn.comb.geno.RData')
load('ETI.gfa.sorted.genes.v230327.RData') # modeled gene sets, up and down, pt ordered, this is recursive
...
jpeg("Fig4.pa.pt.heatmap.v230327.jpeg",height = 160, width = 200, units = "mm",res = 300)
...
pdf('Fig4D.pa.nram.av.v230327.pdf')
...
pdf('Fig4E.pt.nram.av1.v230327.pdf')
...
pdf('Fig4F.eti.pc1.nram.samp.v230327.pdf')
...
pdf('Fig4G.eti.pc1.nram.nega.boot.v230327.pdf')
mp = barplot(rev(quant.comp.nram.pc1[3,]), col=rev(col.b), horiz = T,
             xlim=range(quant.comp.nram.pc1)*1.04, las=1,
             xlab=expression('Contribution to PC1 (log'[2]*')'),
...
save(fix.ef, fix.ef2, offset.cval.90, glm.coefs2, file='Ed.AvrRpt2.focus.0h.RData')
...
#### load data
rm(list=ls())
load('Ed.AvrRpt2.focus.0h.RData')
genotypes = unique(substr(fix.ef2, 1, 4))
genotypes = genotypes[1:16]
...
save(sel.ave.m.0h.ETI, ETI.est.0h, file='sel.ave.m.0h.ETI.RData')
...
jpeg("Fig6B.ETI.0h.NRAM.all.v230327.jpeg",height = 220, width = 120, units = "mm",res = 300)
...
jpeg("Fig6A.0h.nram.heatmap.v230327.jpeg",height = 160, width = 200, units = "mm",res = 300)
...
p2 = ggvenn(df.nega, show_percentage=F, fill_color = c('blue','orange','green'),
            set_name_size = 4)
pdf('Fig7AB.vennD.ETI.r2r1.v230327.pdf', height = 3, width = 5)
...
venn.diagram(list('R2R1_down' = r2r1.up.genes, 
             ...
             filename='Fig7C.r2r1.p.s.venn.r1.tiff', 
...
write.csv(PC1.pcor.09.genes, 'PC1.09.pcor.genes.csv')
write.csv(PC1.ncor.09.genes, 'PC1.09.ncor.genes.csv')
...
write.csv(PC2.pcor.09.genes, 'PC2.09.pcor.genes.csv')
write.csv(PC2.ncor.09.genes, 'PC2.09.ncor.genes.csv')
...
write.csv(PC3.pcor.09.genes, 'PC3.09.pcor.genes.csv')
write.csv(PC3.ncor.09.genes, 'PC3.09.ncor.genes.csv')
...
pdf('Fig.for.TextS1.PC1.PC2.genes.pdf', width = 8, height=7)
...
load('ETI.gfa.sorted.genes.v230327.RData')

pdf('Fig.for.TextS1.PC12gene.plot.pdf', width=8, heigh=8)
...
pdf('Fig.for.TextS1.PC12gene.plot2.v230327.pdf', width=8, heigh=8)
plot(gene.pc1.coord, gene.pc2.coord, cex=0.4, col='gray25',
     xlab='PC1.gene', ylab='PC2.gene',
     xlim=c(-14,19), ylim=c(-14,19))
abline(v=0, col='gray30')
...
pdf('Fig.for.TextS1.PC12gene.plot3.pdf', width=8, heigh=8)
plot(gene.pc1.coord, gene.pc2.coord, cex=0.4, col='gray25',
     xlab='PC1.gene', ylab='PC2.gene',
     xlim=c(-14,19), ylim=c(-14,19))
abline(v=0, col='gray30')
...
write.csv(pc1p2.up, 'pc1p2.up.genes.csv')
write.csv(pc1p2.down, 'pc1p2.down.genes.csv')

## for comparison, PC1 only - not used
pc1.up = names(gene.pc1.coord[gene.pc1.coord > 2])
length(pc1.up)
#[1] 2204
write.csv(pc1.up, 'pc1.up.genes.csv')
...
write.csv(pc1.up.m.pc1p2.up, 'pc1.up.minus.pc1p2.up.genes.csv')
write.csv(pc1p2.up.m.pc1.up, 'pc1p2.up.minus.pc1.up.genes.csv')
...
pdf('Fig.for.TextS1.PC12gene.plot4.pdf', width=8, heigh=8)
plot(gene.pc1.coord, gene.pc2.coord, cex=0.4, col='gray25',
     xlab='PC1.gene', ylab='PC2.gene',
     xlim=c(-14,19), ylim=c(-14,19))
abline(v=0, col='gray30')
...
#[1] 1071
#[1] 458
write.csv(pc2m1.up, 'pc2.minus.pc1.up.genes.csv')
write.csv(pc2m1.down, 'pc2.minus.pc1.down.genes.csv')

#### Yang et al. 2020 Circadian and Diurnal data
#### https://doi.org/10.1074/jbc.RA120.013513
circ.g = read.csv('Yang.2020.circadian.159584_1_supp_509367_q8lbct.csv', header=T, row.names=1)
diur.g = read.csv('Yang.2020.diurnal.159584_1_supp_509370_q8lbct.csv', header=T, row.names=1)
...
pdf('Fig.for.TextS1.PC12gene.circadian.pdf', width=8, heigh=8)
plot(gene.pc1.coord, gene.pc2.coord, cex=0.4, col='gray25',
     xlab='PC1.gene', ylab='PC2.gene',
     xlim=c(-14,19), ylim=c(-14,19))
abline(v=0, col='gray30')
...
pdf('Fig.for.TextS1.PC12gene.diurnal.pdf', width=8, heigh=8)
plot(gene.pc1.coord, gene.pc2.coord, cex=0.4, col='gray25',
     xlab='PC1.gene', ylab='PC2.gene',
     xlim=c(-14,19), ylim=c(-14,19))
abline(v=0, col='gray30')
...
pdf('Fig.for.TextS1.PC12gene.circ.phase.pdf', width=8, heigh=8)
plot(gene.pc1.coord, gene.pc2.coord, cex=0.4, col='gray25',
     xlab='PC1.gene', ylab='PC2.gene',
     xlim=c(-14,19), ylim=c(-14,19))
abline(v=0, col='gray30')
...
pdf('Fig.for.TextS1.PC12gene.diur.phase.pdf', width=8, heigh=8)
plot(gene.pc1.coord, gene.pc2.coord, cex=0.4, col='gray25',
     xlab='PC1.gene', ylab='PC2.gene',
     xlim=c(-14,19), ylim=c(-14,19))
abline(v=0, col='gray30')
...
jpeg("FigS6.mock.model.fit.jpeg",height = 160, width = 270, units = "mm",res = 300)
draw(ht_4x, annotation_legend_list = lgd)
